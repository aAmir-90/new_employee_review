...
module.exports.createEmployee = async(req, res)=>{
    try {
        ...
        if(!name || !email || !passowrd || !company){
...
module.exports.employeeView = async (req, res)=> {
...
// make Admin -- promote employee to admin
// check if
...
module.exports.makeEmployee = async (req, res)=> {
    try {
...
module.exports.employeeReview = async (req, res)=> {
    try {
...
module.exports.askFeedback = async (req, res)=> {
    try {
        const user = req.user;
...
module.exports.cancelFeedback = async (req, res)=> {
    try {
        const user = req.user;
        const { recieverId, giverId } = req.body;
